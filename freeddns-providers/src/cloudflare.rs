...
use freeddns_core::provider::{DdnsProvider, ProviderError};
use reqwest::Client;
...
async fn find_dns_record(
    ...
    let url = format!(
        ...
        CF_API_BASE, zone_id, record_type, record_name
    );
...
async fn create_dns_record(
    ...
    info!("Created {} record for {} -> {}", record_type, name, content);
    Ok(())
}
...
async fn update_dns_record(
    ...
    info!("Updated {} record for {} -> {}", record_type, name, content);
    Ok(())
}
